<p align="right">
   <img src="https://travis-ci.org/vivin/regula.png?branch=1.4-develop" alt="Regula Build Status" />&nbsp;
   <a href='http://coveralls.io/r/vivin/regula?branch=1.4-develop'><img src='http://coveralls.io/repos/vivin/regula/badge.png?branch=1.4-develop' alt='Coverage Status' /></a>
</p>
...
You can download the latest version of Regula on the [releases page](https://github.com/vivin/regula/releases). The latest release is **1.3.1**.
